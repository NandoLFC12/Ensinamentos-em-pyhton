# -*- coding: utf-8 -*-
"""(A) - Exercícios String (2) (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ApOaWehXf7a0Ft2xnhpfw5fZlWu_v6hi
...
if len(cpf) != 11:
    ...
    print('Muito Obrigado, seu CPF foi registrado, aqui foi o CPF registrado {}'.format(cpf))
...
cpf = input('Digite seu CPF (somente números)')
if cpf.count('.') > 1 and cpf.count('-') >= 1:
    a = cpf.replace('-','.')
    novocpf = a.replace('.','')
    print('Muito Obrigado, seu CPF foi registrado, aqui foi o CPF registrado {}'.format(novocpf))
else:
    print('Erro ao confirmar CPF, insira novamente')
...
if email.count('@') == 1 and email.count('.') >= 1 and email.find('.') > email.find('@'):
    print('Dados Registrados: \nNome: {} \nEmail: {}'.format(nome.capitalize(),email))
else:
